export UPLOAD_STR=$(curl --request POST --header "PRIVATE-TOKEN: $API_TOKEN" --form "file=@build/at.megathorx.wsc-api.tar" https://git.heisi.at/api/v4/projects/$CI_PROJECT_ID/uploads)
