cd build
ls -l
export UPLOAD_STR=$(curl --request POST --header "PRIVATE-TOKEN: $API_TOKEN" --form "file=@at.megathorx.wsc_api.tar" https://git.heisi.at/api/v4/projects/$CI_PROJECT_ID/uploads)
