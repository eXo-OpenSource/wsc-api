...
tar -cvf at.megathorx.wsc_api.tar package.xml files.tar templates.tar acptemplates.tar acpMenu.xml userGroupOption.xml aclOption.xml objectType.xml objectTypeDefinition.xml option.xml install.sql language
